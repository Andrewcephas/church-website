        ...
        <div className="container mx-auto max-w-4xl">
          ...
          <Card className="mb-8"><CardContent className="p-0">
            ...
            <div className="p-6 text-center">
              <a href={YOUTUBE_URL} target="_blank" rel="noopener noreferrer"><Button size="lg" className="bg-primary hover:bg-primary/90 text-primary-foreground"><Play className="h-5 w-5 mr-2" />View All on YouTube</Button></a>
            </div>
          </CardContent></Card>
        </div>
      </section>
        ...
        <div className="container mx-auto max-w-4xl text-center">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <Card className="hover:shadow-lg transition-shadow"><CardContent className="p-8 text-center">
              ...
              <a href={YOUTUBE_URL} target="_blank" rel="noopener noreferrer"><Button className="w-full bg-primary hover:bg-primary/90 text-primary-foreground">Subscribe</Button></a>
            </CardContent></Card>
            <Card className="hover:shadow-lg transition-shadow"><CardContent className="p-8 text-center">
              ...
              <a href={FACEBOOK_URL} target="_blank" rel="noopener noreferrer"><Button className="w-full bg-primary hover:bg-primary/90 text-primary-foreground">Join Group</Button></a>
            </CardContent></Card>
          </div>
        </div>
      </section>
