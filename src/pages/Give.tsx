    ...
    <div className="min-h-screen bg-background pt-16">
      ...
      <section className="py-16 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-muted-foreground leading-relaxed mt-8">Your giving supports the work of God through Global Power Church.</p>
          </div>
          <div className="text-center">
            <Card className="hover:shadow-lg transition-shadow">
              <CardContent className="p-8">
                ...
                <a href={WHATSAPP_LINK} target="_blank" rel="noopener noreferrer"><Button size="lg" className="bg-primary hover:bg-primary/90 text-primary-foreground">Send WhatsApp Message</Button></a>
                <p className="text-sm text-muted-foreground mt-4">WhatsApp: 0704 129 211</p>
              </CardContent>
            </Card>
          </div>
        </div>
      ...
      <section className="py-16 px-4 bg-primary text-primary-foreground">
        <div className="container mx-auto max-w-4xl text-center">
          ...
          <a href={WHATSAPP_LINK} target="_blank" rel="noopener noreferrer"><Button size="lg" variant="secondary">Give Now</Button></a>
        </div>
      </section>
    </div>
  );
